    ...
    <main className="min-h-screen bg-[#07080d] text-[#f7f7f8] selection:bg-[#f5c542] selection:text-black">
      <section className="relative min-h-screen overflow-hidden border-b border-white/10">
        ...
        <img
          ...
          alt=""
          className="pointer-events-none absolute left-0 top-0 z-10 h-screen max-h-[900px] w-auto object-contain opacity-70 md:opacity-90"
        />
        ...
        <img
          ...
          alt=""
          className="pointer-events-none absolute right-0 top-0 z-10 h-screen max-h-[900px] w-auto object-contain scale-x-[-1] opacity-70 md:opacity-90"
        />
