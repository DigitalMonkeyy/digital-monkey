    ...
    <main className="min-h-screen bg-[#07080d] text-[#f7f7f8] selection:bg-[#f5c542] selection:text-black">
      <section className="relative min-h-screen overflow-hidden border-b border-white/10">
        ...
        <img
          ...
          alt=""
          className="pointer-events-none absolute left-0 top-[52%] z-10 hidden h-[140vh] max-h-none -translate-y-1/2 -translate-x-[15%] object-contain opacity-90 md:block"
        />
        ...
        <img
          ...
          alt=""
          className="pointer-events-none absolute right-0 top-[52%] z-10 hidden h-[140vh] max-h-none -translate-y-1/2 translate-x-[15%] object-contain scale-x-[-1] opacity-90 md:block"
        />
