    ...
    <main className="min-h-screen bg-[#07080d] text-[#f7f7f8] selection:bg-[#f5c542] selection:text-black">
      <section className="relative min-h-screen overflow-hidden border-b border-white/10">
        ...
        <img
          ...
          alt=""
          className="pointer-events-none absolute left-0 top-[16%] md:top-[30%] -translate-y-1/2 z-10 w-[7vw] max-w-[220px] opacity-70 md:w-[25vw] md:max-w-[420px] md:opacity-90"
        />
        ...
        <img
          ...
          alt=""
          className="pointer-events-none absolute right-0 top-[16%] md:top-[30%] -translate-y-1/2 z-10 w-[7vw] max-w-[220px] scale-x-[-1] opacity-70 md:w-[25vw] md:max-w-[420px] md:opacity-90"
        />
